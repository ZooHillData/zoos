...
export type Database = {
  zoos: {
      ...
      objects_history: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["id"]
            isOneToOne: false
            referencedRelation: "objects_view"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Views: {
      objects_view: {
        Row: {
          access_manage_emails: string[] | null
          access_manage_group_ids: number[] | null
          access_read_emails: string[] | null
          access_read_group_ids: number[] | null
          access_write_emails: string[] | null
          access_write_group_ids: number[] | null
          created_at: string | null
          description: string | null
          folder_id: number | null
          folder_owner_email: string | null
